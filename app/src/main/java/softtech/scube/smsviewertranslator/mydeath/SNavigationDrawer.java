package softtech.scube.smsviewertranslator.mydeath;
...
import softtech.scube.smsviewertranslator.R;
...
public class SNavigationDrawer extends RelativeLayout {
    ...
    protected void initMenu() {
        for (int i = 0; i < menuItemList.size(); i++) {
            ...
            titleTV.setBackgroundColor(getResources().getColor(secondaryMenuItemTextColor));
            //titleTV.setTextColor(secondaryMenuItemTextColor);

            titleTV1.setBackgroundColor(getResources().getColor(primaryMenuItemTextColor));
